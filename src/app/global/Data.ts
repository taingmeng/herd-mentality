export const games = [
  {
    ...
    age: "Age: 8+",
    playPath: "/chameleonz",
    imagePath: "/chameleonz/icon.png",
    paragraphs: [
      "One player is secretly the Chameleon — they can see the grid of words but don't know which word is the secret word.",
      "Everyone else gives a one-word clue. The Chameleon must blend in. Can you spot the Chameleon?",
    ],
  ...
  },
  {
    ...
    duration: "20–30 Min",
    age: "Age: 10+",
    playPath: "/herd-mentalityz",
    imagePath: "/herd-mentalityz/icon.png",
    paragraphs: [
